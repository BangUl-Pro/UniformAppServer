...
//			console.info('json = ' + json);
	...
	socket.on('getMyTimeline', function(data) {
		...
		if (!userId || !schoolId) {
			...
			mySqlConnection.query('SELECT * FROM timelines INNER JOIN users ON timelines.timeline_user_id = ' + userId + ' AND timelines.timeline_school_id = ' + schoolId, function(err, timelineResult) {
				if (err) {
